...
"}")
        ...
        self.agents_1 = QPushButton(self.icon_only_widget)
        self.agents_1.setObjectName(u"agents_1")
        icon5 = QIcon()
        icon5.addFile(u":/images/logo_agents.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon5.addFile(u":/images/logo_agents_gris.png", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        self.agents_1.setIcon(icon5)
        self.agents_1.setCheckable(True)
        self.agents_1.setAutoExclusive(True)

        self.verticalLayout.addWidget(self.agents_1)

        self.statistique_1 = QPushButton(self.icon_only_widget)
        self.statistique_1.setObjectName(u"statistique_1")
        icon6 = QIcon()
        icon6.addFile(u":/images/logo_statistique.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon6.addFile(u":/images/logo_statistique_gris.png", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        self.statistique_1.setIcon(icon6)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/images/logo_parametre.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon7.addFile(u":/images/logo_parametre_gris.png", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        self.parametre_1.setIcon(icon7)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/images/logo_connxion.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"}")
        ...
        self.agents_2 = QPushButton(self.icon_name_widget)
        self.agents_2.setObjectName(u"agents_2")
        self.agents_2.setIcon(icon5)
        self.agents_2.setCheckable(True)
        self.agents_2.setAutoExclusive(True)

        self.verticalLayout_2.addWidget(self.agents_2)

        self.statistiques_2 = QPushButton(self.icon_name_widget)
        self.statistiques_2.setObjectName(u"statistiques_2")
        self.statistiques_2.setIcon(icon6)
        ...
        self.parametre_2.setIcon(icon7)
        ...
        icon9 = QIcon()
        icon9.addFile(u":/images/logo_menu.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/images/logo_recherche.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon11 = QIcon()
        icon11.addFile(u":/images/logo_compte.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.stackedWidget.setMinimumSize(QSize(530, 500))
        ...
        self.label_5.setGeometry(QRect(190, 30, 191, 51))
        ...
        self.label_8 = QLabel(self.clients_page)
        ...
        self.label_9 = QLabel(self.agents_page)
        self.label_9.setObjectName(u"label_9")
        self.label_9.setGeometry(QRect(180, 30, 161, 41))
        self.label_9.setFont(font2)
        self.frame = QFrame(self.agents_page)
        self.frame.setObjectName(u"frame")
        self.frame.setGeometry(QRect(10, 80, 181, 411))
        self.frame.setStyleSheet(u"background-color: rgb(197, 189, 195);")
        self.frame.setFrameShape(QFrame.StyledPanel)
        self.frame.setFrameShadow(QFrame.Raised)
        self.lineEdit_2 = QLineEdit(self.frame)
        self.lineEdit_2.setObjectName(u"lineEdit_2")
        self.lineEdit_2.setGeometry(QRect(20, 50, 141, 20))
        self.label_12 = QLabel(self.frame)
        self.label_12.setObjectName(u"label_12")
        self.label_12.setGeometry(QRect(20, 30, 47, 13))
        self.label_12.setFont(font1)
        self.label_13 = QLabel(self.frame)
        self.label_13.setObjectName(u"label_13")
        self.label_13.setGeometry(QRect(20, 110, 47, 13))
        self.label_13.setFont(font1)
        self.lineEdit_3 = QLineEdit(self.frame)
        self.lineEdit_3.setObjectName(u"lineEdit_3")
        self.lineEdit_3.setGeometry(QRect(20, 130, 141, 20))
        self.lineEdit_4 = QLineEdit(self.frame)
        self.lineEdit_4.setObjectName(u"lineEdit_4")
        self.lineEdit_4.setGeometry(QRect(20, 210, 141, 20))
        self.lineEdit_5 = QLineEdit(self.frame)
        self.lineEdit_5.setObjectName(u"lineEdit_5")
        self.lineEdit_5.setGeometry(QRect(20, 290, 141, 20))
        self.pushButton = QPushButton(self.frame)
        self.pushButton.setObjectName(u"pushButton")
        self.pushButton.setGeometry(QRect(30, 380, 121, 23))
        self.pushButton.setStyleSheet(u"background-color: rgb(130, 128, 127);\n"
"border-radius:20%;")
        self.label_14 = QLabel(self.frame)
        self.label_14.setObjectName(u"label_14")
        self.label_14.setGeometry(QRect(20, 190, 81, 16))
        self.label_14.setFont(font1)
        self.label_15 = QLabel(self.frame)
        self.label_15.setObjectName(u"label_15")
        self.label_15.setGeometry(QRect(20, 270, 131, 16))
        self.label_15.setFont(font1)
        self.stackedWidget.addWidget(self.agents_page)
        ...
        self.label_11 = QLabel(self.parametre_page)
        self.label_11.setObjectName(u"label_11")
        self.label_11.setGeometry(QRect(170, 230, 191, 51))
        ...
        self.agents_1.toggled.connect(self.agents_2.setChecked)
        self.agents_2.toggled.connect(self.agents_1.setChecked)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.agents_2.setText(QCoreApplication.translate("MainWindow", u"Agents", None))
        ...
        self.label_9.setText(QCoreApplication.translate("MainWindow", u"Agents page", None))
        self.label_12.setText(QCoreApplication.translate("MainWindow", u"Pr\u00e9nom", None))
        self.label_13.setText(QCoreApplication.translate("MainWindow", u"Nom", None))
        self.pushButton.setText(QCoreApplication.translate("MainWindow", u"Cr\u00e9er un nouvel agent", None))
        self.label_14.setText(QCoreApplication.translate("MainWindow", u"Adresse mail", None))
        self.label_15.setText(QCoreApplication.translate("MainWindow", u"Num\u00e9ro de t\u00e9l\u00e9phone", None))
        self.label_10.setText(QCoreApplication.translate("MainWindow", u"Statistiques page", None))
        self.label_11.setText(QCoreApplication.translate("MainWindow", u"Param\u00e8tre page", None))
    # retranslateUi
